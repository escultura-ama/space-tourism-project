...
export default function CrewCarousel() {
  ...
  return (
    <section className="bg-lg-crew-bg bg-cover flex flex-col h-screen bg-black pt-20 md:pt-28 md:pb-0 lg:px-28 justify-evenly md:justify-start">
      ...
      <div className="flex flex-col lg:flex-row justify-around items-center">
        <div className="px-8 mt-6 md:mt-0 text-center lg:text-left lg:h-full lg:w-1/2">
          <h2 className="Bellefair opacity-50 text-white tracking-wider uppercase md:text-xl lg:text-[32px]">{active.role}</h2>
          <h1 className="Bellefair text-2xl md:text-4xl md:mt-2 mb-6 md:mb-4 font-semibold text-white lg:text-[56px] mt-4 lg:mt-8 lg:leading-tight uppercase">{active.name}</h1>
          <p className="text-primaryText text-base barlow md:px-0 mb-8 md:mb-14 lg:px-0 lg:w-2/3 lg:mt-12">{active.bio}</p>
